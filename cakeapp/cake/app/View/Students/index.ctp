<div class="students index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('student_code');?></th>
	...
	<tr>
		...
		<td><?php echo h($student['Student']['student_code']); ?>&nbsp;</td>
		<td><?php echo h($student['Student']['student_name']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Jobapplications'), array('controller' => 'jobapplications', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Jobapplications'), array('controller' => 'jobapplications', 'action' => 'add')); ?> </li>
